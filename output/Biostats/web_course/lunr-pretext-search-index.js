...
},
{
  ...
  "body": " MATH-132B Final Project   Throughout the semester, you and your group members will conduct a series of statistical experiments on a biologically, ecologically, medicaly, and\/or pharmaceutically-oriented data set. The culmination of your efforts will be a written analysis (worth 65 points) and a 15-minute presentation (worth 35 points) on your findings.    Selecting a Group and Data Set  Your group and your group's data set must be selected by the beginning of class on Monday, September 14 . Each group must consist of betweem 4-6 people. Please note that you will be working closely with your group throughout the course of the semester.  Your data set must satisfy each of the below criteria.    Written Report  The majority of the credit for this assignment will come from work that you do over the course of the semester. The report you write will be based on each of the below activities from class. Each of the sections will be worth the number of points listed beside it.    Activity Topic  Points    Histograms  10    Boxplots  10    Hypothesis Testing (1 Stat)  10    Hypothesis Testing (2 Stats)  10    Independence  10    One-Way AnOVa  10    Regression  10    Nonparametric Testing  10    In addition to the sections listed above, you will also formulate your own scientific question (that remains unanswered) based on your group's data set. For this portion of the assignment, you will need to determine and conduct an appropriate statistical experiment to help answer your question. Then, you will use the results of your test to draw a final conclusion.   "
}
]
